...
/** Object::Carolina_Trips_to_Invoice
...
class Carolina_Trips_to_Invoice {
	...
	//: Public functions
	//: Accessors
	/** Carolina_Trips_to_Invoice::getApiUrl()
	*   base url to call
	*   @return string
	*/
	...
	/** Carolina_Trips_to_Invoice::getExcelFile()
	...
	/** Carolina_Trips_to_Invoice::setExcelFile($_setFile)
	...
	/** Carolina_Trips_to_Invoice::getFileName()
	 *  @return string: $this->_excelFileName
	 */
	...
	/** Carolina_Trips_to_Invoice::setFileName($_setFile)
	 *  @param string: $_setFile
	 */
	...
	/** Carolina_Trips_to_Invoice::writeExcelFile($excelFile, $excelData)
	...
	//: Magic
	/** Carolina_Trips_to_Invoice::__construct()
	* Class constructor
	*/
	public function __construct() {
		try {
			...
			$reportDates = (array) $this->createDateRangeArray($startDate, date("Y-m-d"));
			...
			foreach ($constructedDates as $key1 => $value1) {
				foreach ($value1 as $key2 => $value2) {
					...
					foreach($value2 as $key3 => $value3) {
						...
						$reportUrl = $this->getApiUrl()."report=" . strval(self::REPORT_NUMBER) . "&responseFormat=csv&Start_Date=" . $reportData[0] . "&Stop_Date=" . $reportData[1] . "&Business_Unit=1";
	...
	/** Carolina_Trips_to_Invoice::__destruct()
		* Class destructor
