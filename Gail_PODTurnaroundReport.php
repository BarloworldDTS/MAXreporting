...
/** Object::Gail_PODTurnaroundReport
 ...
 */
class Gail_PODTurnaroundReport {
	//: Constants
	const REPORT_NUMBER = 76;
	const REPORT_NAME = "POD Turnaround";
	const DOC_OWNER = "Clinton Wright";
	const DOC_FILE_NAME = "Gail_PODTurnaroundReport";
	...
	//: Public functions
	//: Accessors
	/** Gail_PODTurnaroundReport::getApiUrl()
	*   base url to call
	*   @return string
	*/
	...
	/** Gail_PODTurnaroundReport::getExcelFile()
	...
	/** Gail_PODTurnaroundReport::setExcelFile($_setFile)
	...
	/** Gail_PODTurnaroundReport::getFileName()
	 *  @return string: $this->_excelFileName
	 */
	...
	/** Gail_PODTurnaroundReport::setFileName($_setFile)
	 *  @param string: $_setFile
	 */
	...
	/** Gail_PODTurnaroundReport::writeExcelFile($excelFile, $excelData)
	...
	//: Magic
	/** Gail_PODTurnaroundReport::__construct()
	* Class constructor
	*/
	...
	/** Gail_PODTurnaroundReport::__destruct()
		* Class destructor
