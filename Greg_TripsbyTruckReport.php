...
/** Object::Greg_TripsbyTruckReport
...
class Greg_TripsbyTruckReport {
	...
	//: Public functions
	//: Accessors
	/** Greg_TripsbyTruckReport::getApiUrl()
	*   base url to call
	*   @return string
	*/
	...
	/** Greg_TripsbyTruckReport::getExcelFile()
	...
	/** Greg_TripsbyTruckReport::setExcelFile($_setFile)
	...
	/** Greg_TripsbyTruckReport::getFileName()
	 *  @return string: $this->_excelFileName
	 */
	...
	/** Greg_TripsbyTruckReport::setFileName($_setFile)
	 *  @param string: $_setFile
	 */
	...
	/** Greg_TripsbyTruckReport::writeExcelFile($excelFile, $excelData)
	...
	//: Magic
	/** Greg_TripsbyTruckReport::__construct()
	* Class constructor
	*/
	...
	/** Greg_TripsbyTruckReport::__destruct()
		* Class destructor
