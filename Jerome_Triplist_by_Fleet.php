...
/** Object::Jerome_Triplist_by_Fleet
 ...
 */
class Jerome_Triplist_by_Fleet {
	//: Constants
	...
	const DOC_FILE_NAME = "Jerome_Triplist_by_Fleet";
	...
	//: Public functions
	//: Accessors
	/** Jerome_Triplist_by_Fleet::getApiUrl()
	*   base url to call
	*   @return string
	*/
	...
	/** Jerome_Triplist_by_Fleet::getExcelFile()
	...
	/** Jerome_Triplist_by_Fleet::setExcelFile($_setFile)
	...
	/** Jerome_Triplist_by_Fleet::getFileName()
	 *  @return string: $this->_excelFileName
	 */
	...
	/** Jerome_Triplist_by_Fleet::setFileName($_setFile)
	 *  @param string: $_setFile
	 */
	...
	/** Jerome_Triplist_by_Fleet::writeExcelFile($excelFile, $excelData)
	...
	//: Magic
	/** Jerome_Triplist_by_Fleet::__construct()
	* Class constructor
	*/
	...
	/** Jerome_Triplist_by_Fleet::__destruct()
		* Class destructor
